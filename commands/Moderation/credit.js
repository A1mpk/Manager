...
module.exports = {
  ...
  execute(message, args) {
    ...
    const ARGSN2EEDED = new Discord.MessageEmbed()
      ...
      .setDescription(
        "`>credit <mention>` - This is a credit command, it simply credits a user. All you have to do is mention a member & the reason why you are crediting them. [Click here to see credit embed.](https://gyazo.com/8cda39aa907a69088f494c2d322f6c1f)"
      )
