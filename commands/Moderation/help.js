        ...
        if(!Words){
         ...
         .setTimestamp()
          ...
          message.channel.send(Music2)
            ...
            .setColor("#9f3b39")
            .addField('invite', '`>invite` - This is just an invite command, it sends you an invite link so you can invite Prover.')
            ...
            .addField('info','`>info` - This is just an info command, it shows you information about Prover.')
